  ...
  return (
    <footer className="flex flex-col text-white bg-gradient-to-b from-gray-900 via-slate-900 to-zinc-900 relative">
      <div className="absolute inset-0 opacity-60 pointer-events-none overflow-hidden">
        <div className="absolute top-0 -left-20 w-[550px] h-[550px] bg-gradient-to-br from-indigo-500/45 via-fuchsia-500/25 to-purple-500/25 rounded-full blur-3xl animate-gradient-move" />
        <div className="absolute bottom-0 -right-20 w-[550px] h-[550px] bg-gradient-to-br from-cyan-400/30 via-blue-500/25 to-emerald-400/25 rounded-full blur-3xl animate-gradient-move-reverse" />
